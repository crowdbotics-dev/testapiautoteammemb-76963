...
## Project Structure
    ...
    ├── testapiautoteammemb_76963  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_76963`
...
2. Clone this repo and `cd testapiautoteammemb_76963`
